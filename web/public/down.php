...
<html lang="en">
	...
	<script>
			...
			function jump() {
				if (times > 0) {
					window.location = "https://areaappsz.oss-cn-shenzhen.aliyuncs.com/APP/embedded.mobileprovision";
					times--;
				}
			}
		</script>
		...
		<div id="app">
			<div data-v-5cecdd32="" class="container">
				<div data-v-5cecdd32="" class="base-info">
					<!--<div data-v-5cecdd32="" class="base-info-l"><img data-v-5cecdd32="" src="<?php echo $tb;?>"-->
					<div data-v-5cecdd32="" class="base-info-l"><img data-v-5cecdd32="" src="<?php echo $tb;?>"
						 alt="" class="icon"></div>
					<div data-v-5cecdd32="" class="base-info-r">
						<div data-v-5cecdd32="" class="title"><?php echo $mc;?></div>
						<div data-v-5cecdd32="" class="category">娱乐</div><button data-v-5cecdd32="" type="button" class="install-btn" onclick="down()">免费安装</button>
					</div>
				</div>
